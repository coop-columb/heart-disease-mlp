...
from src.data.preprocess import (
    load_data, binarize_target, handle_missing_values, 
    create_preprocessing_pipeline, split_data
)
from src.features.feature_engineering import (
    create_feature_interactions, create_medical_risk_score,
    calculate_cardiovascular_age, normalize_categorical_levels,
    select_features
)
...
def main(config_path, raw_data_path=None, processed_dir=None):
    ...
    additional_features = [
        'age_sex', 'cp_exang', 'bp_chol', 'risk_score', 'cardiovascular_age'
    ]
    ...
    engineered_numerical = [col for col in df.columns 
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--raw-data-path", type=str, default=None,
